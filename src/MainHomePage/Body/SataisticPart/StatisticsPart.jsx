...
const fetchReferrerStats = async () => {
  const res = await axios.get("http://localhost:8080/api/referre");
  return res.data;
};
...
const fetchAnalytics = async () => {
  const res = await axios.get("http://localhost:8080/api/browser");
  return res.data;
};
...
const fetchCountryStats = async () => {
  const res = await axios.get("http://localhost:8080/api/country");
  return res.data;
};
